...
mod tree_sitter_bindings {
    ...
    extern "C" {
        ...
        /// - The tree-sitter-mml parser is generated by tree-sitter CLI
        /// - The C code is compiled and linked via build.rs
        /// - The Language struct is opaque and managed by tree-sitter library
