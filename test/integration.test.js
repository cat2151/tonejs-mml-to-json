...
describe('Integration: mml2ast + ast2json', () => {
  describe('Complete pipeline', () => {
    ...
    it('should convert melody "cdefgab" through full pipeline', () => {
      ...
      expect(json).toHaveLength(10); // setup + 7 notes + loopEnd
    ...
    it('should convert MML with rests "c r d" through full pipeline', () => {
      ...
      expect(json).toHaveLength(5); // setup + 2 notes (rest doesn't create event)
    ...
    it('should convert complex MML sequence', () => {
      ...
      expect(json).toHaveLength(11); // setup + 8 notes (rest doesn't create event)
  ...
  describe('Edge cases', () => {
    it('should handle empty MML string', () => {
      ...
      expect(json).toHaveLength(3); // Just setup commands
    });
